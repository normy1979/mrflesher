...
export default function About() {
    ...
    <div class="about-div" id="abt">
        ...
        <p><em>When I'm not on the computer, you can find me trying my best to follow the wisdom of the honu, that is to: </em></p>
        <dl>
            <dd>Spend more time at the beach.</dd>
            <dd>Travel at your own pace.</dd>
            <dd>Let worries roll off your back.</dd>
            <dd>Trust the flow.</dd>
            <dd>Stay calm under pressure.</dd>
            <dd>Be comfortable in your own shell.</dd>
            <dd>Enjoy time alone.</dd>
